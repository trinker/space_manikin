...
I realized quickly a raster was messy.  I read up a bit on them in the R Journal ([click here](http://journal.r-project.org/archive/2011-1/RJournal_2011-1_Murrell.pdf)).  In the process of reading and fooling around with [Picasa](http://picasa.google.com/) I turned my original silhouette (body.png) blue and couldn't fix him.  I headed back to http://www.flaticon.com/free-icon/standing-frontal-man-silhouette_10633 to download another.  In this act I saw you could download a svg file of the png.  I thought maybe this will be less messier and easier to change colors.  This lead me to a google search and finding the `grImport` package after seeing his [listserve post](https://stat.ethz.ch/pipermail/r-sig-geo/2009-February/005003.html).  And then I saw an article from Paul <a href="http://www.jstatsoft.org/v30/i04/">Murrell (2009)</a> and figured I could turn the svg (I didn't realize what svg was until I opened it in Notepad++) into a ps file and read into R and convert to a flexible grid grob.
